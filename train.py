...
parser.add_argument("--task", type=str, default="perception")
...
parser.add_argument("--wandb-project", type=str, default="fMRI-Classification")
...
if args.ckpt is not None:
    ...
    model = fMRIClassifier(num_classes=150, lr=args.lr)
